              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children:[
                    ...
                    InkWell(
                      onTap:(){
                       CartCubit.get(context).deleteCart(cartProducts.sId!);
                      },
                      child: Row(
                        children: [
                          ...
                          InkWell(
                            onTap:(){
                              cartProducts.quantity==1?null:CartCubit.get(context).updateQuantity(cartProducts.sId,--cartProducts.quantity);
                            },
                            child: Container(
                              decoration: BoxDecoration(
                          ...
                          InkWell(
                            onTap:(){
                              CartCubit.get(context).addToCart(cartProducts.sId);
                            },
                            child: Container(
                              decoration: BoxDecoration(
